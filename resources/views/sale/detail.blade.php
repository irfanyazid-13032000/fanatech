...
@section('content')
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"> </span> Detail Data Sale</h4>
    <div class="card">
        <div class="d-flex pe-4">
            <h5 class="card-header">Detail Data Sale</h5>
        </div>
...
@push('addon-script')
    ...
    var urlAjax = "{{ route('data-sale', ['id' => ':id']) }}"
